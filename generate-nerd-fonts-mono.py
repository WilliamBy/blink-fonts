    ...
    for font, paths in fonts.items():
        ...
        with open(filename, 'w') as fd:
            ...
            args = {
                'font': font,
                'name': name,
                'regular': 'Regular/{}NerdFontMono-Regular.ttf'.format(font),
                'bold': 'Bold/{}NerdFont-BoldMono.ttf'.format(font),
                'italic': 'Italic/{}NerdFontMono-Italic.ttf'.format(font),
                'bold_italic': 'Bold-Italic/{}NerdFontMono-BoldItalic.ttf'.format(font),
            }
            args.update(paths)
